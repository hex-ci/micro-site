...
const defaultPlugins = ['imagemin-gifsicle', 'imagemin-jpegtran', './imagemin-optipng', 'imagemin-svgo'];

const loadPlugin = (plugin, ...args) => {
  try {
    return require(plugin)(...args);
  }
  catch (error) {
...
module.exports.gifsicle = exposePlugin('imagemin-gifsicle');
module.exports.jpegtran = exposePlugin('imagemin-jpegtran');
module.exports.optipng = exposePlugin('./imagemin-optipng');
module.exports.svgo = exposePlugin('imagemin-svgo');
